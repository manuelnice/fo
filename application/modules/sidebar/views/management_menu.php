          ...
          <nav class="nav-primary hidden-xs">
            <ul class="nav">
              <li class="<?php if($page == 'home'){echo  "active"; }?>">
                <a href="<?=base_url()?>management"> <i class="fa fa-dashboard icon"> <b class="bg-danger"></b> </i>
              <span>Home</span> </a> </li>
              <li class="<?php if($page == 'profile' OR $page == 'posts' OR $page == 'students'){echo  "active"; }?>"> <a href="<?=base_url()?>" > <i class="fa fa-user icon"> <b class="bg-success"></b> </i>
                ...
                <ul class="nav lt">
                  ...
                  <li class="<?php if($page == 'posts'){echo  "active"; }?>"> <a href="<?=base_url()?>management/posts" > <i class="fa fa-angle-right"></i>
                ...
                <li class="<?php if($page == 'study' OR $page == 'transcripts'){echo  "active"; }?>"> <a href="<?=base_url()?>" >
                  ...
                  <span>Exams </span> </a>
                  <ul class="nav lt">
                    <li class="<?php if($page == 'transcripts'){echo  "active"; }?>"> <a href="<?=base_url()?>management/transcripts" > <i class="fa fa-angle-right"></i>
                    <span>Results </span> </a> </li>
                    <li class="<?php if($page == 'study'){echo  "active"; }?>"> <a href="<?=base_url()?>management/exam_issues" > <i class="fa fa-angle-right"></i>
                    <span>Exam Issues </span> </a> </li>
                  </ul> </li>
                  ...
                  <li class="<?php if($page == 'notes' OR $page == 'assignments' OR $page == 'notice'){echo  "active"; }?>"> <a href="<?=base_url()?>tasks" > <i class="fa fa-tasks icon"> <b class="bg-success"></b> </i>
                    ...
                    <span>Tasks </span> </a>
                    <ul class="nav lt">
                      <li class="<?php if($page == 'notes'){echo "active"; } ?>"> <a href="<?=base_url()?>management/ratings" > <i class="fa fa-angle-right"></i>
                      <span>Ratings </span> </a> </li>
                      <li class="<?php if($page == 'assignments'){echo "active"; } ?>"> <a href="<?=base_url()?>management/reports" > <i class="fa fa-angle-right"></i>
                      <span>Fee Reports </span> </a> </li>
                      <li class="<?php if($page == 'notice'){echo "active"; } ?>"> <a href="<?=base_url()?>management/notice" > <i class="fa fa-angle-right"></i>
