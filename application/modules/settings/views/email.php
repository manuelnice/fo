...
<input type="hidden" name="r_url" value="<?=uri_string()?>">
			...
			<div class="form-group">
				<label class="col-lg-2 control-label"><?=lang('company_email')?> <span class="text-danger">*</span></label>
				<div class="col-lg-10">
			...
			<div class="form-group">
				<label class="col-lg-2 control-label"><?=lang('email_protocol')?> <span class="text-danger">*</span></label>
				<div class="col-lg-4">
			...
			<div class="form-group">
				<label class="col-lg-2 control-label"><?=lang('smtp_host')?> </label>
				<div class="col-lg-6">
			...
			<div class="form-group">
				<label class="col-lg-2 control-label"><?=lang('smtp_user')?></label>
				<div class="col-lg-6">
			...
			<?php $this->load->library('encrypt'); ?>
				<label class="col-lg-2 control-label"><?=lang('smtp_pass')?></label>
				<div class="col-lg-4">
					<input type="password" class="form-control" value="<?=$this->encrypt->decode($this->config->item('smtp_pass'));?>" name="smtp_pass">
				</div>
			</div>
			<div class="form-group">
				<label class="col-lg-2 control-label"><?=lang('smtp_port')?></label>
				<div class="col-lg-4">
