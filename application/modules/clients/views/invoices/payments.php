      ...
      ?>
              ...
              <div style="width: 70%;float: left;">
                <div style="width: 100%;padding: 11px 0;">
                  ...
                  <div style="width:65%;border-bottom:1px solid #eee;float:right;foat:right;"><?=$this->config->item('default_currency')?> <?=number_format($client_payable,2)?></div>
                  <div style="clear:both;"></div>
            ...
            <div style="text-align:center;color:white;float:right;background:#FC8174;width: 25%;
              ...
              <div style="padding-top:10px">
                ...
                if ($query->num_rows() > 0){
                  ...
                  <a href="<?=base_url()?>clients/inv_manage/details/<?=$row['invoice']?>">
