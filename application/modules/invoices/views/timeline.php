...
<section id="content">
	<section class="hbox stretch">
		...
		<p class="h4"><?=lang('all_invoices')?></p>
			...
			<a href="<?=base_url()?>invoices/manage/details/<?=$inv->inv_id?>" data-original-title="<?=lang('view_details')?>" data-toggle="tooltip" data-placement="bottom" class="btn btn-dark btn-sm"><i class="fa fa-info-circle"></i> <?=lang('invoice_details')?></a>

			<a href="<?=base_url()?>invoices/manage/quickadd/<?=$inv->inv_id?>" title="<?=lang('item_quick_add')?>" class="btn btn-sm btn-danger" data-toggle="ajaxModal"><i class="fa fa-list-alt text-white"></i></a> 
