...
<a href="<?=base_url()?>projects/files/download/<?=$f->file_id*1800?>/<?=$f->project*1200?>" title="<?=lang('download_file')?>" class="btn btn-dark btn-xs active"><i class="fa fa-download text-white text-active"></i></a>
