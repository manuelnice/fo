	...
	<div class="modal-content">
		...
		<div class="modal-body">
			<p><?=lang('email_sending_warning')?></p>
				...
				<label class="col-lg-4 control-label"><?=lang('start_date')?></label> 
				<div class="col-lg-8">
				<input class="input-sm input-s datepicker-input form-control" size="16" type="text" value="<?=date('d-m-Y')?>" name="end_date" data-date-format="dd-mm-yyyy" >
				</div> 
				</div> 
				<div class="form-group"> 
		...
		<button type="submit" class="btn btn-info"><?=lang('create_project')?></button>
		</form>
		</div>
	</div>
	<!-- /.modal-content -->
