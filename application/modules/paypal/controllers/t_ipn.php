...
class T_ipn extends MX_Controller {
    ...
    function ipn()
    {
        ...
        $activity = 'Payment of '.$this->config->item('default_currency').' '.$paid_amount.' received and applied to INVOICE #'.$invoice_ref;

            $this->_log_activity($invoice_id,$activity,$icon = 'fa-usd',$client); //log activity
    ...
    function _notifyme($client_email,$client_username,$invoice_ref)
    {
            ...
            //$this->email->to('mandai.willy@gmail.com'); //for testing only
