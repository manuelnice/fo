		...
		<?php
          ...
          echo form_open($paypal_url,$attributes); ?>
			 ...
			 <div class="form-group">
				...
				<div class="form-group">
				<label class="col-lg-4 control-label"><?=lang('amount')?> (<?=$this->config->item('default_currency_symbol')?>) </label>
				<div class="col-lg-4">
					<input type="text" class="form-control" value="<?=number_format($invoice_info['amount'],2)?>" readonly>
				</div>
				</div>

				<img src="<?=IMG_URL?>payment_2checkout.png">
				<img src="<?=IMG_URL?>payment_american.png">
				<img src="<?=IMG_URL?>payment_discover.png">
				<img src="<?=IMG_URL?>payment_maestro.png">
				<img src="<?=IMG_URL?>payment_paypal.png">
