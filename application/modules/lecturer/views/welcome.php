	...
	<section class="panel panel-default">
		<div class="row m-l-none m-r-none bg-light lter">
			<div class="col-sm-6 col-md-3 padder-v b-r b-light">
				...
				<span class="h3 block m-t-xs"><strong>30 </strong>
				</span> <small class="text-muted text-uc">Assignments </small> </a>
			</div>
			<div class="col-sm-6 col-md-3 padder-v b-r b-light">
				<span class="fa-stack fa-2x pull-left m-r-sm"> <i class="fa fa-circle fa-stack-2x text-danger"></i> <i class="fa fa-tasks fa-stack-1x text-white"></i>
				</span> <a class="clear" href="#">
				<span class="h3 block m-t-xs"><strong>45 </strong>
				</span> <small class="text-muted text-uc">Submissions </small> </a>
			</div>
			<div class="col-sm-6 col-md-3 padder-v b-r b-light">
				...
				<span class="h3 block m-t-xs"><strong>5</span></strong>
				<small class="text-muted text-uc">Units </small> </a>
			</div>
		...
		<div class="row">
			<div class="col-md-8">
				<section class="panel panel-default">
								...
								<td class="text-right">
									<div class="btn-group"> <a href="table-static.html#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-pencil"></i></a>
										<ul class="dropdown-menu pull-right">
											<li><a href="table-static.html#">Update Assignment</a></li>
											<li><a href="table-static.html#">Delete Assignment</a></li>
										</ul>
									</div>
								</td>
							</tr>
					...
					<div class="col-lg-4">
						<section class="panel panel-default">
						<header class="panel-heading">Submissions</header>
						<table class="table table-striped m-b-none text-sm">
							<thead>
								<tr>
									<th>Stats </th>
