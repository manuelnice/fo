    ...
    <p class="h4"><?=lang('all_payments')?></p>
      ...
      foreach ($payments as $key => $p) { ?>
        ...
        <a href="<?=base_url()?>collaborator/payments/details/<?=$p->p_id?>">
          INV <?=$this->user_profile->get_invoice_details($p->invoice,'reference_no')?>
          ...
          <div style="font-size:10pt; font-family: Open Sans;">
            ...
            <div style="text-align:center;color:white;float:right;background:#78ae54;width: 25%;
              ...
              <div style="padding-top:10px">
                <div style="width:75%;border-bottom:1px solid #eee;float:right"><strong><a href="#"><?=ucfirst($this->user_profile->get_profile_details($i->paid_by,'fullname')? $this->user_profile->get_profile_details($i->paid_by,'fullname'):$i->username)?></a></strong></div>
