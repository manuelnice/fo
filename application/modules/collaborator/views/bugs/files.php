...
<ul class="list-group no-radius m-b-none m-t-n-xxs list-group-lg no-border"> 
		...
		<a href="#" class="thumb-sm pull-left m-r-sm"> <img src="<?=AVATAR_URL?>
...
<a href="<?=base_url()?>collaborator/bug_files/delete/<?=$f->file_id*1800?>/<?=$f->bug*1200?>" data-toggle="ajaxModal" class="btn btn-danger btn-xs active"><i class="fa fa-trash-o text-active"></i></a>
