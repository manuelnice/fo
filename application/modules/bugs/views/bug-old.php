...
<section id="content"> <section class="vbox"> <section class="scrollable padder">
	...
	<div class="row text-sm wrapper">
		...
		<a href="<?=base_url()?>bugs/view/add" data-toggle="ajaxModal" class="btn btn-sm btn-dark"><i class="fa fa-plus"></i> <?=lang('new_bug')?></a>
		</div>
	...
	<div class="table-responsive">
		<table class="table table-striped b-t b-light text-sm">
			<thead>
				...
				<tr>
					<td><a class="text-primary" href="<?=base_url()?>bugs/view/details/<?=$bug->bug_id?>">#<?=$bug->issue_ref?></a></td>
					<td class="hidden-xs"><a class="text-primary" href="<?=base_url()?>projects/view/details/<?=$bug->project_id?>">#<?=$bug->project_code?></a></td>
					<td><?=ucfirst($this->user_profile->get_user_details($bug->reporter,'username'))?></td>
					<td><a class="text-primary" href="<?=base_url()?>bugs/assign_to/<?=$bug->bug_id?>/<?=$bug->issue_ref?>" data-toggle="ajaxModal" >
					...
					<td class="hidden-xs"><?php
							...
							?> ago</td>
					<td><a class="text-primary" href="<?=base_url()?>bugs/mark_status/<?=$bug->bug_id?>/<?=$bug->issue_ref?>" data-toggle="ajaxModal" >
					<?=$bug->bug_status?> </a>
					</td>
					<td>
					...
					<a href="<?=base_url()?>bugs/delete/<?=$bug->bug_id?>" data-toggle="ajaxModal" class="btn btn-dark btn-xs">
