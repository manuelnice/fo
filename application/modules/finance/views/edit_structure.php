<section id="content"> <section class="vbox">
  ...
  <section class="scrollable wrapper">
    ...
    <div class="row">
      ...
      <div class="panel-body">
        ...
        <input type="hidden" name="fee_id" value="<?=$this->uri->segment(4)?>">
          <div class="form-group">
          <label>Year of Study</label>
          <select name="yos" class="form-control m-b">
            <option value="<?=$f->yos?>">Select Year</option>
        ...
        <div class="form-group">
          ...
          <select name="sem" class="form-control m-b">
            <option value="<?=$f->sem?>">Select Semester</option>
            <option value="1">One</option>
            <option value="2">Two</option>
          </select>
        </div>
         ...
         <div class="form-group">
          ...
          <select name="program" class="form-control m-b">
            <option value="<?=$f->program_id?>">Select Program</option>
            <?php
            if (!empty($programs)) {
        ...
        <div class="form-group">
          ...
          <input type="text" class="form-control" name="fee_desc" value="<?=$f->fee_desc?>">
        </div>
         <div class="form-group">
          <label>Optional</label>
          <select name="optional" class="form-control m-b">
            <option value="<?=$f->optional?>">Select Semester</option>
  ...
  <div class="form-group">
          ...
          <select name="common_fee" class="form-control m-b">
            <option value="<?=$f->common_fee?>">Select Semester</option>
            <option value="Yes">Yes</option>
            <option value="No">No</option>
          </select>
        </div>
        <div class="form-group">
          <label>Amount</label>
          <input type="number" class="form-control" name="amount" value="<?=$f->amount?>">
        </div>
       
       
      
        
        <button type="submit" class="btn btn-sm btn-danger">Add Payment</button>
      </form>
      <?php } ?>
    </div>
  </section>
