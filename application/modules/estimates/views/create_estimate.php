	...
	<section class="hbox stretch">
		...
		<p class="h4"><?=lang('all_estimates')?></p>
			...
			foreach ($estimates as $key => $estimate) { 
				...
				<small class="block small text-muted">EST <?=$estimate->reference_no?> | <?=strftime("%b %d, %Y", strtotime($estimate->date_saved));?> <span class="label label-<?=$label?>"><?=$invoice_status?></span></small>
